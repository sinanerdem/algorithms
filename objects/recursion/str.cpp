...
-----------------------------------------------------------------*/
str::str(const char ch, bool d) :_display(d), _str(d, 2){
  if (display()) {
...
Constructor that takes char* as argument
-----------------------------------------------------------------*/
str::str(const char* s, bool d) :_display(d), _str(d, 5){
  if (display()) {
...
this->_str(s._str)
-----------------------------------------------------------------*/
str::str(const str& s) :_display(s._display), _str(s._str){ //NOTE THIS CALL - IMPT I
  if (s.display()) {
