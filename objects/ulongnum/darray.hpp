...
-----------------------------------------------------------------*/
template <typename T>
darray<T>::darray(bool d, int size) :_element(nullptr), _display(d), _size(size){
  if (display()) {
...
----------------------------------------------------------*/
template <typename T>
darray<T>::darray(const T f[], int size, bool d) : _element(nullptr), _display(d), _size(size) {
  if (display()) {
